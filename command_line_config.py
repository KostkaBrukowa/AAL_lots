...
def create_parser():
    ...
    parser.add_argument('-a', help='A is the length of horizontal side', default=5)
    # parser.add_argument('-a', help='A is the length of horizontal side', default=random.randint(5, 7))
    parser.add_argument('-b', help='B is the length of vertical side', default=5)
    # parser.add_argument('-b', help='B is the length of vertical side', default=random.randint(5, 6))
    parser.add_argument('-p', help='P is number of points inside the rectangle', default=random.randint(4, 8))
